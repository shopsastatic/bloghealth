...
import { GetAuthorWithPostsAndPageQuery, NcgeneralSettingsFieldsFragmentFragment } from "@/__generated__/graphql";
...
const Page: FaustPage<GetAuthorWithPostsAndPageQuery> = (props) => {
